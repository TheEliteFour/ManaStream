 ...
 */
package net.manastream.core.ManaStream.Utis.Vectors;
...
/**
 *
 * This class is taken verbatim from UniversalElectricity. All credit belongs to
 * it's author.
 *
...
public class Vector3 extends Vector2 implements Cloneable {
	...
	if (MagicConnections.isConnector(tileEntity)) {
	    if (MagicConnections.canConnect(tileEntity, getOrientationFromSide(side, ForgeDirection.NORTH))) {
		return tileEntity;
	    }
	}
     ...
     * given side. The side numbers are compatible with the function
     * "getBlockTextureFromSideAndMetadata".
     *
     * Bottom: 0; Top: 1; Back: 2; Front: 3; Left: 4; Right: 5;
     *
     * @param front - The direction in which this block is facing/front. Use a
