...
/**
 * Register your block to allow a channel connection with this class. This class
 * manages the visual aspect of a channel connection and does not effect the
 * actual transmission of magic.
 *
 * @author Calclavia
 *
 */
public class MagicConnections {
    ...
    /**
     * Returns the directions in which this block may connect or be connected
     * from.
     */
